...
public class Sistema {
    ...
    public void conferirValidadeCompeticao() {
        if(usuarios.isEmpty()){
            iniciarAdmin();
            System.out.println();
        } else {
            if(ChronoUnit.DAYS.between(usuarios.get(0).getDataCadastro(), LocalDate.now()) > 180) {
                System.out.println("A competicao referente ao semestre atual terminou.");
                verClassificacao();
                System.exit(0);
            }
        }
    ...
    public void verClassificacao() {
        ...
        if(this.usuarios.isEmpty()) {
            ...
            for(Usuario usuario : this.usuarios) {
                if(usuario instanceof Membro membro) { // Cast para Membro
    ...
    public void cadastrarUsuario() {
        ...
        while(retornarUsuario(nome) != null) {
            System.out.print("O nome ja esta em uso... Tente novamente: ");
            nome = t.nextLine();
        }
    ...
    public void iniciarAdmin() {
        ...
        this.usuarios.add(new Diretor(nome, senha, email, diretoria));
